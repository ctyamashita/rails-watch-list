...
# Movie.create(title: "Hobkitty", overview: "The reluctant kitty, Kyuuko, goes on a journey with Kurou to retrieve the treasures once lost.", poster_url: asset-url('legacy-02.png'), rating: 9.9)
